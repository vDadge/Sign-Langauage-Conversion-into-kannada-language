...
test_data1 = os.listdir('C:/Users/Vivek/Desktop/source_code/C/')
dot= []
labels = []
# Trainfea = []
for iii in range(0,len(test_data1)):
    test_data_img = os.listdir('C:/Users/Vivek/Desktop/source_code/C/'+test_data1[iii]+'/')

    for img in test_data_img:
        
        try:
            img_1 = plt.imread('C:/Users/Vivek/Desktop/source_code/C/'+test_data1[iii] + "/" + img)
...
Characters_list = [chr(0x0cA8),chr(0x0C95),chr(0x0C9C)]
